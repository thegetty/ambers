...
[^77.AO.81.6](#cat-77.AO.81.6){.CatalogueObjRef} is discussed here as the head of a horse, but on the analogy of the representation of some hippocamps in Etruscan art, particularly, it may in fact be the head of a hippocamp (see entry for [Hippocamp, cat. no. 29](#cat-78.AO.286.1){.CatalogueObjRef}.
